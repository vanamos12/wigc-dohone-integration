...
<section class="mbr-section form4 cid-qUu84lQnfb" id="form4-1b">
  ...
  <?php 
	...
	$smt = "UPDATE tbl_livres SET titre=:titre, auteur=:auteur, Photo=:Photo, parution=:parution, editeur=:editeur, autreediteur=:autreediteur, prixpapier=:prixpapier, prixnumerique=:prixnumerique, contenu=:contenu
